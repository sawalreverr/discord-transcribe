...
const ConfigSchema = z.object({
    ...
    whisperCpp: z.object({
        binaryPath: z.string().default('./whisper.cpp/build/bin/main'),
        modelPath: z.string().default('./whisper.cpp/models/ggml-medium.bin'),
        language: z.string().default('id'),
    }),
    rateLimit: z.object({
    ...
    audio: z.object({
        maxChunkSeconds: z.number().default(20),
